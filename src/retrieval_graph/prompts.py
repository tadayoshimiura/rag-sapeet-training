...
def _load_prompts() -> dict:
    ...
    path = root / "configs" / "system_prompts.json"
    if not path.exists():
        return {}
...
ROUTER_SYSTEM_PROMPT = _PROMPTS.get("retrieval_router_prompt", "")
GENERAL_SYSTEM_PROMPT = _PROMPTS.get("retrieval_general_prompt", "")
MORE_INFO_SYSTEM_PROMPT = _PROMPTS.get("retrieval_more_info_prompt", "")
RESEARCH_PLAN_SYSTEM_PROMPT = _PROMPTS.get("retrieval_research_plan_prompt", "")
RESPONSE_SYSTEM_PROMPT = _PROMPTS.get("retrieval_response_prompt", "")
GENERATE_QUERIES_SYSTEM_PROMPT = _PROMPTS.get("retrieval_generate_queries_prompt", "")
